	...
	if ($error === 0) {
		if ($img_size > 10000000 || $img_size1 > 10000000 || $img_size2 > 10000000 || $img_size3 > 10000000 || $img_size4 > 10000000 || $img_size5 > 10000000) {
			...
			if (in_array($img_ex_lc, $allowed_exs) || in_array($img_ex_lc1, $allowed_exs1) || in_array($img_ex_lc2, $allowed_exs2) || in_array($img_ex_lc3, $allowed_exs3) || in_array($img_ex_lc4, $allowed_exs4)|| in_array($img_ex_lc5, $allowed_exs5)) {
				...
				$sql = "INSERT INTO images(addresh,bath,bed,price,descreption,amenities1,amenities2,amenities3,amenities4,amenities5,amenities6,image_url,image_url1,image_url2,image_url3,image_url4,image_url5) 
				        VALUES('$add','$bathe','$bed','$price','$descrip','$amenities1','$amenities2','$amenities3','$amenities4','$amenities5','$amenities6','$new_img_name' ,'$new_img_name1','$new_img_name2','$new_img_name3','$new_img_name4','$new_img_name5')";
