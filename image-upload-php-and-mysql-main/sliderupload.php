	...
	if ($error === 0) {
		if ($img_size > 10000000 || $img_size1 > 10000000 || $img_size2 > 10000000 ) {
			...
			if (in_array($img_ex_lc, $allowed_exs) || in_array($img_ex_lc1, $allowed_exs1) || in_array($img_ex_lc2, $allowed_exs2) ) {
				...
				$img_upload_path = 'slider_uploads/'.$new_img_name;
				$img_upload_path1= 'slider_uploads/'.$new_img_name1;
				$img_upload_path2= 'slider_uploads/'.$new_img_name2;
				...
				$sql = "INSERT INTO slider(image1,image2,image3) 
				        VALUES('$new_img_name','$new_img_name1','$new_img_name2')";
				mysqli_query($conn, $sql);
				header("Location: sliderdatabase.php");
			}else {
				$em = "You can't upload files of this type";
		        header("Location: sliderdatabase.php?error=$em");
			}
		}
	}else {
