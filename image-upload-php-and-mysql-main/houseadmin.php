    ...
    <?php if (isset($_GET['error'])): ?>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">housesale</h5>
               <form action="houseupload.php" method="post" enctype="multipart/form-data" class="row g-3">
                <div class="col-md-12">
                ...
                <div class="col-md-12">
                  <div class="form-floating">
                    <input type="text" name="title" class="form-control" id="floatingName" placeholder="Address">
